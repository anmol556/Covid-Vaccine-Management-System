	...
	<div class="row">
		...
		<form method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
			<div class="form-group">
				<label>Health ID:</label><input type="text" name="HealthID" class="form-control" autofocus placeholder="HealthID">
			</div>
			<div class="form-group">
...
if(isset($_POST['submit']))
{
  ...
  $idsearch="select *from register where HealthID='$HealthID'";
  $query=mysqli_query($con,$idsearch);
...
if($idcount)
{
  ...
  $dbpass=$id_pass['Password'];
$_SESSION['name'] = $id_pass['name'];
$_SESSION['HealthID']=$id_pass['HealthID'];
$_SESSION['age']=$id_pass['age'];
